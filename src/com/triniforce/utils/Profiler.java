...
public class Profiler implements IProfiler {
    ...
    static class Group{
        ...
        public void addItem(Item item) {
        	if(null == item){
        		Logger.getLogger(getClass().getName()).log(Level.SEVERE, "Null item");
        		return;
        	}
        	if(null == item.getName()){
        		Logger.getLogger(getClass().getName()).log(Level.SEVERE, "Null item name");
        		return;
        	}
        ...
        public void release(PSI psi) throws EWrongPSI {
        	...
        	synchronized (m_profiler) {
                ...
                if(psi.getStackNumber() != e.getStackNumber()){
                    Logger.getLogger(getClass().getName()).log(Level.SEVERE, psi.getGroup()+"."+ psi.getItem() + " / " +e.getGroup()+"."+ e.getItem());
